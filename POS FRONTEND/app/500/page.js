            ...
            <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 text-center">
                <div className="max-w-md w-full bg-white border border-slate-200 rounded-2xl shadow-xl p-8 flex flex-col items-center">
                    ...
                    <div className="flex justify-center w-full">
                        <button
                            onClick={() => router.push('/')}
                            className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white font-medium text-sm px-6 py-2.5 rounded-lg shadow-sm transition-colors duration-150"
                        >
                            Home
                        </button>
                    </div>
