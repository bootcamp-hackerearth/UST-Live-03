...
public class ModelsController extends BaseController {
    ...
    public WsDto<ModelsDto> list(@RequestBody PaginationDto paginationDto) {
        ...
        if (StringUtils.isNotEmpty(paginationDto.getKeyword())) {
            Specification<Models> spec = buildGlobalSearchSpec(Models.class, paginationDto.getKeyword());
            return modelsService.findAll(spec, pageable, paginationDto.getKeyword());
        }
