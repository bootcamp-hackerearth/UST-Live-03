...
public class ApiModelsController extends BaseController {

    public ApiModelsController(ModelsService modelsService) {
    ...
    @PostMapping("/list")
    @PreAuthorize("hasAnyAuthority('ADMIN','MANAGER','INVENTORY_MANAGER','AUDITOR')")
