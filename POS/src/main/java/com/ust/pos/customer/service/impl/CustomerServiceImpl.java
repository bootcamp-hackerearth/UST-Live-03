...
public class CustomerServiceImpl extends CommonService implements CustomerService {
    ...
    public CustomerDto findByIdentifier(String identifier) {
        return modelMapper.map(requireResource(customerRepository.findByIdentifier(identifier), CUSTOMER_WITH_IDENTIFIER + identifier + NOT_FOUND), CustomerDto.class);
    }

    @Override
    public CustomerDto findByIdentifierWithAddressDto(String identifier) {
        Customer customer = requireResource(customerRepository.findByIdentifier(identifier), "Customer not found: " + identifier);
    ...
    public CustomerDto update(CustomerDto customerDto) {
        String identifier = customerDto.getIdentifier();
        Customer existingCustomer = requireResource(customerRepository.findByIdentifier(identifier), CUSTOMER_WITH_IDENTIFIER + identifier + NOT_FOUND);
    ...
    public boolean delete(String identifier) {
        Customer customer = requireResource(customerRepository.findByIdentifier(identifier), CUSTOMER_WITH_IDENTIFIER + identifier + NOT_FOUND);
        softDelete(customer);
