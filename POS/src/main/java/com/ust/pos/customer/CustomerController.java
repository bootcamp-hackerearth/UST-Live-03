...
public class CustomerController {
    ...
    @GetMapping("/add")
    public String add(Model model, @ModelAttribute("customerDto") CustomerDto customerDto, @ModelAttribute("billing") AddressDto billing, @ModelAttribute("shipping") AddressDto shipping) {
        return "customer/add";
    }
