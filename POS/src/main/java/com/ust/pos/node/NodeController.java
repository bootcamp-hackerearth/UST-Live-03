...
public class NodeController {
    ...
    public String addPost(Model model,
        ...
        redirectAttributes.addFlashAttribute("successMessage", "Node added successfully!");
    ...
    public String delete(@RequestParam String identifier,
        ...
        redirectAttributes.addFlashAttribute("successMessage", "Node deleted successfully!");
        return REDIRECT_NODE_LIST;
    }
}