...
public class ShelfController {
    ...
    @GetMapping("/add")
    public String add(Model model, Pageable pageable, @ModelAttribute ShelfDto shelfDto) {
        model.addAttribute(SHELFS, shelfService.findAll(pageable));
        return "shelf/add";
    }

    @PostMapping("/add")
    public String doadd(Model model, Pageable pageable, @ModelAttribute ShelfDto shelfDto) {
    ...
    @PostMapping("/update")
    public String doupdate(Model model, Pageable pageable, @ModelAttribute ShelfDto shelfDto) {
